        ...
        className="h-[290px] p-1 rounded-md ease-in-out duration-300 hover:scale-125"/> */}
          ...
          <div className="px-10 py-10">
            <p className="text-xl text-white dark:text-white leading-8">
              ...
              finally found a balance in full stack development. As a new graduate from InceptionU’s Full Stack Developer program,
              I am eager to build intuitive, functional, and beautiful applications.{" "}
            </p>
          </div>
        </div>
